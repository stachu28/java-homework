...
public class Main {
    static void main(String[] args) {
        ...
        BigDecimal total1 = scanner.nextBigDecimal();
        System.out.println("Enter number of participants: ");
        int people = scanner.nextInt();
        BigDecimal each = total1.divide(
        ...
        BigDecimal price = scanner.nextBigDecimal();
        BigDecimal rounded1 = price.setScale(2, RoundingMode.CEILING);
        System.out.println(rounded1 + " zł");
